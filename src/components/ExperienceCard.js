    ...
    >
      <StyledExperienceHeadDiv>
        <StyledExperienceHeadLeftDiv>
          ...
          <div>
            <p>University of Warmia and Mazury in Olsztyn</p>
      ...
      <StyledExperienceBodyDiv>
        <ul>
          <li>
            ...
            <span>
              I was responsible for creating a map component using the leaflet
              library and other related functionalities.
            </span>
          </li>
        </ul>
        <StyledExperienceCardFooterWrapperDiv>
